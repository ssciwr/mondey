...
# todo: Should be refactored and: A) file path links should always go to DataManager
# B) the util functions here which are still used should either go into UserManager or DataManager.
