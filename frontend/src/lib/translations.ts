...
export const translationIds = {
	...
	admin: {
		...
		calendarEventExternalLink: "External Link",
		calendarEventCreatedSuccess: "Calendar event created successfully",
		calendarEventUpdatedSuccess: "Calendar event updated successfully",
		calendarEventDeletedSuccess: "Calendar event deleted successfully",
		calendarEventCreateError: "Failed to create calendar event",
		calendarEventUpdateError: "Failed to update calendar event",
		calendarEventDeleteError: "Failed to delete calendar event",
		calendarEventLoadError: "Failed to load calendar events",
		calendarEventsNotFound: "No calendar events found",
		age: "Alter",
		score: "Punktzahl",
