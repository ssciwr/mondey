...
export const translationIds = {
	...
	admin: {
		...
		userResearcher: "Wissenschaftler",
		userFullDataAccess: "Vollständiger Datenzugriff",
		userResearchCode: "Forschungscode",
		userAdmin: "Admin",
		addResearchCode: "Forschungscode hinzufügen",
		...
		calendarEventDate: "Veranstaltungsdatum",
		calendarEventExternalLink: "Externer Link",
		calendarEventCreatedSuccess: "Kalenderereignis erfolgreich erstellt",
		calendarEventUpdatedSuccess: "Kalenderereignis erfolgreich aktualisiert",
		calendarEventDeletedSuccess: "Kalenderereignis erfolgreich gelöscht",
		calendarEventCreateError: "Fehler beim Erstellen des Kalenderereignisses",
		calendarEventUpdateError:
			"Fehler beim Aktualisieren des Kalenderereignisses",
		calendarEventDeleteError: "Fehler beim Löschen des Kalenderereignisses",
		calendarEventLoadError: "Fehler beim Laden der Kalenderereignisse",
		calendarEventsNotFound: "Keine Kalenderereignisse gefunden",
		age: "Alter",
		score: "Punktzahl",
