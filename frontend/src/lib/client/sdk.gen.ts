...
/**
 * Get Child Milestone Expected Age Ranges
 */
export const getChildMilestoneExpectedAgeRanges = <ThrowOnError extends boolean = false>(options?: Options<GetChildMilestoneExpectedAgeRangesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetChildMilestoneExpectedAgeRangesResponse, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
/**
 * Post Child Milestone Expected Age Ranges
 */
export const postChildMilestoneExpectedAgeRanges = <ThrowOnError extends boolean = false>(options: Options<PostChildMilestoneExpectedAgeRangesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, PostChildMilestoneExpectedAgeRangesError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
