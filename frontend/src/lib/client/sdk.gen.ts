...
import type { GetEventsData, GetEventsResponse, GetPublicDocumentsData, GetPublicDocumentsResponse, GetLanguagesData, GetLanguagesResponse, GetMilestonesData, GetMilestonesResponse, GetMilestoneData, GetMilestoneResponse, GetMilestoneError, GetMilestoneGroupsData, GetMilestoneGroupsResponse, GetMilestoneGroupsError, SubmitMilestoneImageData, SubmitMilestoneImageError, GetUserQuestionsData, GetUserQuestionsResponse, GetChildQuestionsData, GetChildQuestionsResponse, CreateEventData, CreateEventResponse, CreateEventError, DeleteEventData, DeleteEventError, UpdateEventData, UpdateEventResponse, UpdateEventError, GetDocumentsData, GetDocumentsResponse, CreateDocumentData, CreateDocumentResponse, CreateDocumentError, DeleteDocumentData, DeleteDocumentError, UpdateDocumentData, UpdateDocumentResponse, UpdateDocumentError, CreateLanguageData, CreateLanguageResponse, CreateLanguageError, DeleteLanguageData, DeleteLanguageError, UpdateI18nData, UpdateI18nError, TranslateData, TranslateResponse, TranslateError, GetMilestoneGroupsAdminData, GetMilestoneGroupsAdminResponse, CreateMilestoneGroupAdminData, CreateMilestoneGroupAdminResponse, UpdateMilestoneGroupAdminData, UpdateMilestoneGroupAdminResponse, UpdateMilestoneGroupAdminError, DeleteMilestoneGroupAdminData, DeleteMilestoneGroupAdminResponse, DeleteMilestoneGroupAdminError, OrderMilestoneGroupsAdminData, OrderMilestoneGroupsAdminError, UploadMilestoneGroupImageData, UploadMilestoneGroupImageError, CreateMilestoneData, CreateMilestoneResponse, CreateMilestoneError, UpdateMilestoneData, UpdateMilestoneResponse, UpdateMilestoneError, DeleteMilestoneData, DeleteMilestoneResponse, DeleteMilestoneError, OrderMilestonesAdminData, OrderMilestonesAdminError, UploadMilestoneImageData, UploadMilestoneImageResponse, UploadMilestoneImageError, DeleteMilestoneImageData, DeleteMilestoneImageError, GetSubmittedMilestoneImagesData, GetSubmittedMilestoneImagesResponse, ApproveSubmittedMilestoneImageData, ApproveSubmittedMilestoneImageError, DeleteSubmittedMilestoneImageData, DeleteSubmittedMilestoneImageError, GetMilestoneAgeScoresData, GetMilestoneAgeScoresResponse, GetMilestoneAgeScoresError, AdminUpdateStatsData, AdminUpdateStatsResponse, GetMilestoneAnswerSessionsData, GetMilestoneAnswerSessionsResponse, ModifyMilestoneAnswerSessionData, ModifyMilestoneAnswerSessionError, GetMilestoneAnswerSessionAnalysisData, GetMilestoneAnswerSessionAnalysisResponse, GetMilestoneAnswerSessionAnalysisError, GetUserQuestionsAdminData, GetUserQuestionsAdminResponse, CreateUserQuestionData, CreateUserQuestionResponse, UpdateUserQuestionData, UpdateUserQuestionResponse, UpdateUserQuestionError, DeleteUserQuestionData, DeleteUserQuestionResponse, DeleteUserQuestionError, OrderUserQuestionsAdminData, OrderUserQuestionsAdminError, GetChildQuestionsAdminData, GetChildQuestionsAdminResponse, CreateChildQuestionData, CreateChildQuestionResponse, UpdateChildQuestionData, UpdateChildQuestionResponse, UpdateChildQuestionError, DeleteChildQuestionData, DeleteChildQuestionResponse, DeleteChildQuestionError, OrderChildQuestionsAdminData, OrderChildQuestionsAdminError, GetAdminSettingsData, GetAdminSettingsResponse, UpdateAdminSettingsData, UpdateAdminSettingsResponse, UpdateAdminSettingsError, GetUsersData, GetUsersResponse, GetResearchGroupsData, GetResearchGroupsResponse, CreateResearchGroupData, CreateResearchGroupResponse, CreateResearchGroupError, DeleteResearchGroupData, DeleteResearchGroupError, ImportCsvDataData, ImportCsvDataError, UsersCurrentUserData, UsersCurrentUserResponse, UsersPatchCurrentUserData, UsersPatchCurrentUserResponse, UsersPatchCurrentUserError, UsersDeleteUserData, UsersDeleteUserResponse, UsersDeleteUserError, UsersUserData, UsersUserResponse, UsersUserError, UsersPatchUserData, UsersPatchUserResponse, UsersPatchUserError, GetChildrenData, GetChildrenResponse, CreateChildData, CreateChildResponse, CreateChildError, UpdateChildData, UpdateChildResponse, UpdateChildError, DeleteChildData, DeleteChildResponse, DeleteChildError, GetChildData, GetChildResponse, GetChildError, DeleteChildImageData, DeleteChildImageError, GetChildImageData, GetChildImageError, UploadChildImageData, UploadChildImageError, GetCurrentMilestoneAnswerSessionData, GetCurrentMilestoneAnswerSessionResponse, GetCurrentMilestoneAnswerSessionError, UpdateMilestoneAnswerData, UpdateMilestoneAnswerResponse, UpdateMilestoneAnswerError, GetCurrentUserAnswersData, GetCurrentUserAnswersResponse, UpdateCurrentUserAnswersData, UpdateCurrentUserAnswersResponse, UpdateCurrentUserAnswersError, GetCurrentChildAnswersData, GetCurrentChildAnswersResponse, GetCurrentChildAnswersError, UpdateCurrentChildAnswersData, UpdateCurrentChildAnswersError, GetCompletedMilestoneAnswerSessionsData, GetCompletedMilestoneAnswerSessionsResponse, GetCompletedMilestoneAnswerSessionsError, GetMilestonegroupsForSessionData, GetMilestonegroupsForSessionResponse, GetMilestonegroupsForSessionError, GetSummaryFeedbackForAnswersessionData, GetSummaryFeedbackForAnswersessionResponse, GetSummaryFeedbackForAnswersessionError, GetDetailedFeedbackForAnswersessionData, GetDetailedFeedbackForAnswersessionResponse, GetDetailedFeedbackForAnswersessionError, AuthCookieLoginData, AuthCookieLoginResponse, AuthCookieLoginError, AuthCookieLogoutData, AuthCookieLogoutResponse, RegisterRegisterData, RegisterRegisterResponse, RegisterRegisterError, ResetForgotPasswordData, ResetForgotPasswordError, ResetResetPasswordData, ResetResetPasswordError, VerifyRequestTokenData, VerifyRequestTokenError, VerifyVerifyData, VerifyVerifyResponse, VerifyVerifyError, ReauthenticateSessionData, ReauthenticateSessionResponse, ReauthenticateSessionError, GetResearchDataData, GetResearchNamesData, GetResearchNamesResponse, GetResearchNamesError } from './types.gen';
 ...
 */
export const getPublicDocuments = <ThrowOnError extends boolean = false>(options?: Options<GetPublicDocumentsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetPublicDocumentsResponse, unknown, ThrowOnError>({
        url: '/documents/',
        ...options
    });
};
...
export const deleteEvent = <ThrowOnError extends boolean = false>(options: Options<DeleteEventData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, DeleteEventError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
export const getDocuments = <ThrowOnError extends boolean = false>(options?: Options<GetDocumentsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetDocumentsResponse, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
export const deleteDocument = <ThrowOnError extends boolean = false>(options: Options<DeleteDocumentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, DeleteDocumentError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
export const updateDocument = <ThrowOnError extends boolean = false>(options: Options<UpdateDocumentData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateDocumentResponse, UpdateDocumentError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
export const deleteMilestoneGroupAdmin = <ThrowOnError extends boolean = false>(options: Options<DeleteMilestoneGroupAdminData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteMilestoneGroupAdminResponse, DeleteMilestoneGroupAdminError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
export const deleteMilestone = <ThrowOnError extends boolean = false>(options: Options<DeleteMilestoneData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteMilestoneResponse, DeleteMilestoneError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
export const adminUpdateStats = <ThrowOnError extends boolean = false>(options?: Options<AdminUpdateStatsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<AdminUpdateStatsResponse, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
 ...
 */
export const getMilestoneAnswerSessions = <ThrowOnError extends boolean = false>(options?: Options<GetMilestoneAnswerSessionsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetMilestoneAnswerSessionsResponse, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
 ...
 */
export const modifyMilestoneAnswerSession = <ThrowOnError extends boolean = false>(options: Options<ModifyMilestoneAnswerSessionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<unknown, ModifyMilestoneAnswerSessionError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
 ...
 */
export const getMilestoneAnswerSessionAnalysis = <ThrowOnError extends boolean = false>(options: Options<GetMilestoneAnswerSessionAnalysisData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetMilestoneAnswerSessionAnalysisResponse, GetMilestoneAnswerSessionAnalysisError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
export const deleteUserQuestion = <ThrowOnError extends boolean = false>(options: Options<DeleteUserQuestionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteUserQuestionResponse, DeleteUserQuestionError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
export const deleteChildQuestion = <ThrowOnError extends boolean = false>(options: Options<DeleteChildQuestionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteChildQuestionResponse, DeleteChildQuestionError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
export const getAdminSettings = <ThrowOnError extends boolean = false>(options?: Options<GetAdminSettingsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAdminSettingsResponse, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
 ...
 * Update admin settings.
 */
export const updateAdminSettings = <ThrowOnError extends boolean = false>(options: Options<UpdateAdminSettingsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<UpdateAdminSettingsResponse, UpdateAdminSettingsError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
export const deleteChild = <ThrowOnError extends boolean = false>(options: Options<DeleteChildData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteChildResponse, DeleteChildError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
 ...
 */
export const getCompletedMilestoneAnswerSessions = <ThrowOnError extends boolean = false>(options: Options<GetCompletedMilestoneAnswerSessionsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCompletedMilestoneAnswerSessionsResponse, GetCompletedMilestoneAnswerSessionsError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
 ...
 */
export const reauthenticateSession = <ThrowOnError extends boolean = false>(options: Options<ReauthenticateSessionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ReauthenticateSessionResponse, ReauthenticateSessionError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
...
export const getResearchNames = <ThrowOnError extends boolean = false>(options?: Options<GetResearchNamesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetResearchNamesResponse, GetResearchNamesError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'fastapiusersauth',
