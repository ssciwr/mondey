...
export type GetAgeIntervalsResponse = (Array<AgeInterval>);

export type GetAgeIntervalsError = unknown;

export type CreateAgeIntervalData = {
    query: {
        high: number;
        low: number;
    };
...
export type CreateAgeIntervalResponse = (AgeInterval);

export type CreateAgeIntervalError = (HTTPValidationError);

export type UpdateAgeIntervalData = {
    path: {
...
export type UpdateAgeIntervalResponse = (AgeInterval);

export type UpdateAgeIntervalError = (HTTPValidationError);

export type DeleteAgeIntervalData = {
    path: {
        age_interval_id: number;
    };
};

export type DeleteAgeIntervalResponse = (unknown);

export type DeleteAgeIntervalError = (HTTPValidationError);
