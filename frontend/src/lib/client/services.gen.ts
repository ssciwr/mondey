...
export const translate = <ThrowOnError extends boolean = false>(options: Options<TranslateData, ThrowOnError>) => {
    return (options?.client ?? client).post<TranslateResponse, TranslateError, ThrowOnError>({
        ...options,
        url: '/admin/translate/'
    });
};
...
export const adminUpdateStats = <ThrowOnError extends boolean = false>(options: Options<AdminUpdateStatsData, ThrowOnError>) => {
    return (options?.client ?? client).post<AdminUpdateStatsResponse, AdminUpdateStatsError, ThrowOnError>({
        ...options,
 ...
 * Get Research Data
 */
export const getResearchData = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetResearchDataResponse, GetResearchDataError, ThrowOnError>({
        ...options,
        url: '/research/data/'
    });
};