...
export const getMilestoneGroups = <ThrowOnError extends boolean = false>(options: Options<GetMilestoneGroupsData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetMilestoneGroupsResponse, GetMilestoneGroupsError, ThrowOnError>({
        ...options,
        url: '/milestone-groups/childid={child_id}'
    });
};

/**
 * Get Milestone Groups For Answersession
 */
export const getMilestoneGroupsForAnswersession = <ThrowOnError extends boolean = false>(options: Options<GetMilestoneGroupsForAnswersessionData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetMilestoneGroupsForAnswersessionResponse, GetMilestoneGroupsForAnswersessionError, ThrowOnError>({
        ...options,
        url: '/milestone-groups/answersession_id={answersession_id}'
    });
};
