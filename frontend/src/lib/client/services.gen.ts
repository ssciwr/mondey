...
/**
 * Update Milestone Age Scores
 */
export const updateMilestoneAgeScores = <ThrowOnError extends boolean = false>(options: Options<UpdateMilestoneAgeScoresData, ThrowOnError>) => {
    return (options?.client ?? client).post<UpdateMilestoneAgeScoresResponse, UpdateMilestoneAgeScoresError, ThrowOnError>({
        ...options,
        url: '/admin/update-milestone-age-scores/{update_existing_statistics}'
    });
};
