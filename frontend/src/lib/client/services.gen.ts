...
import type {
	...
	GetChildrenError,
	GetChildrenResponse,
	GetCurrentChildAnswersData,
	GetCurrentChildAnswersError,
	...
	UpdateChildResponse,
	UpdateCurrentChildAnswersData,
	UpdateCurrentChildAnswersError,
	UpdateCurrentChildAnswersResponse,
 ...
 */
export const getCurrentMilestoneAnswerSession = <
 ...
 */
export const getCurrentChildAnswers = <ThrowOnError extends boolean = false>(
	options: Options<GetCurrentChildAnswersData, ThrowOnError>,
) => {
	return (options?.client ?? client).get<
		GetCurrentChildAnswersResponse,
		GetCurrentChildAnswersError,
 ...
 */
export const updateCurrentChildAnswers = <ThrowOnError extends boolean = false>(
	options: Options<UpdateCurrentChildAnswersData, ThrowOnError>,
) => {
	return (options?.client ?? client).put<
		UpdateCurrentChildAnswersResponse,
		UpdateCurrentChildAnswersError,
