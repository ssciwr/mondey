 ...
 * Get Age Intervals
 */
export const getAgeIntervals = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetAgeIntervalsResponse, GetAgeIntervalsError, ThrowOnError>({
        ...options,
        url: '/age-intervals'
    });
};
 ...
 * Create Age Interval
 */
export const createAgeInterval = <ThrowOnError extends boolean = false>(options: Options<CreateAgeIntervalData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateAgeIntervalResponse, CreateAgeIntervalError, ThrowOnError>({
        ...options,
        url: '/age-intervals'
    });
};
 ...
 * Update Age Interval
 */
export const updateAgeInterval = <ThrowOnError extends boolean = false>(options: Options<UpdateAgeIntervalData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdateAgeIntervalResponse, UpdateAgeIntervalError, ThrowOnError>({
        ...options,
        url: '/age-intervals/{age_interval_id}'
    });
};
 ...
 * Delete Age Interval
 */
export const deleteAgeInterval = <ThrowOnError extends boolean = false>(options: Options<DeleteAgeIntervalData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteAgeIntervalResponse, DeleteAgeIntervalError, ThrowOnError>({
        ...options,
        url: '/age-intervals/{age_interval_id}'
    });
};
